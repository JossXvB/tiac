...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: '𝑻𝒊𝒂 𝒄𝒂𝒓𝒐  🍓', thumbnail: imagen1, sourceUrl: ''}}}}, aa);
